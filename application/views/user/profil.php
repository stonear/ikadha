<div class="row clearfix">
	...
	<div class="col-sm-9 col-xs-12">
		<div class="card">
			...
			<div class="body">
				<form class="form-horizontal" autocomplete="off" role="form" action="<?php echo base_url(); ?>User/update_profil" method="post">
					<div class="row clearfix">
...
<div class="modal fade" id="foto" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form action="<?php echo base_url(); ?>User/foto_alumni" method="post" enctype="multipart/form-data">
